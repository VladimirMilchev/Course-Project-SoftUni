...
from estore.apps.orders.models import Order
from estore.apps.orders.views import user_orders
...
class WishlistView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        return super().get_queryset().filter(users_wishlist=self.request.user)
